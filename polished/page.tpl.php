...
<body class="<?php print $body_classes; ?>">
    ...
    <div id="site-header" class="container-16 clear-block">
      ...
      <?php if ($main_menu_links || $secondary_menu_links): ?>
	    <div id="site-menu" class="grid-10">
	      <div class="main clear-block"><?php print $main_menu_links; ?></div>
	      <div class="sub clear-block"><?php print $secondary_menu_links; ?></div>
	    </div>
		  <?php endif; ?>
		  <?php if ($search_box): ?>
  ...
  <div id="page" class="container-16 clear-block">
    <div id="header-region" class="grid-16 clear-block">
    <?php print $mission; ?>
