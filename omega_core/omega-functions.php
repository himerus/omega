...
function _omega_save_layout_files($scss, $css, $theme) {
  ...
  $layoutscss = realpath(".") . $base_path . drupal_get_path('theme', 'omega') . '/style/scss/layout.scss';
  $layoutcss = realpath(".") . $base_path . drupal_get_path('theme', 'omega') . '/style/css/layout.css';
