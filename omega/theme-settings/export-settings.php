...
/**
 * @file
 * Implements custom theme settings adjustments for Omega Five theme exports.
 */

// Custom settings in Vertical Tabs container.
$form['subtheme-generator'] = [
  '#type' => 'vertical_tabs',
...
$form['export']['export_details'] = [
  '#type' => 'details',
  '#attributes' => ['class' => ['export-details']],
...
$form['export']['export_details']['theme_friendly_name'] = [
  '#type' => 'textfield',
  '#title' => t('Theme name'),
  '#maxlength' => 50,
  '#size' => 30,
...
$form['export']['export_details']['theme_machine_name'] = [
  '#type' => 'machine_name',
  '#maxlength' => 50,
  '#size' => 30,
  ...
  '#default_value' => '',
  '#machine_name' => [
    'exists' => [$omegaSettings, 'omegaThemeExists'],
    'source' => ['export', 'export_details', 'theme_friendly_name'],
...
$form['export']['export_details']['export_description'] = [
  '#type' => 'textfield',
  '#title' => t('Description'),
...
$form['export']['export_details']['export_version'] = [
  '#type' => 'textfield',
  '#title' => t('Version'),
...
if (count($omega_subthemes) == 0) {
  unset($clone_options['clone']);
}

$form['export']['export_options']['export_type'] = [
  '#type' => 'radios',
  '#title' => t('Create a:'),
...
$omegaSubThemes = ['omega' => 'Omega'] + $omega_subthemes;

$form['export']['export_options']['export_theme_base'] = [
  '#type' => 'select',
  '#options' => $omegaSubThemes,
  '#title' => t('Omega Sub-Theme'),
  // Set $theme as default so if we are using the generator inside a subtheme,
  // it will auto select the current theme as the new base of a clone/kit.
  '#default_value' => $theme,
...
$form['export']['export_options']['export_destination_path'] = [
  '#type' => 'select',
  '#options' => $exportPaths,
...
// STATES VARIABLES.
$omega_state__type_clone = [':input[name="export[export_options][export_type]"]' => ['value' => 'clone']];
$omega_state__type_subtheme = [':input[name="export[export_options][export_type]"]' => ['value' => 'subtheme']];
$omega_state__base_omega = [':input[name="export[export_options][export_theme_base]"]' => ['value' => 'omega']];

// Variable to represent state to apply to clone themes only.
$clone_state = [
  'visible' => [
    ':input[name="export[export_options][export_type]"]' => ['value' => 'clone'],
  ],
];
...
$subtheme_state = [
  'visible' => [
    ':input[name="export[export_options][export_type]"]' => ['value' => 'subtheme'],
  ],
];

$form['export']['export_options']['export_options_clone'] = [
  '#type' => 'item',
...
$form['export']['export_options']['export_options_kit'] = [
  '#type' => 'item',
  '#prefix' => '<div class="description omega-export-options">',
...
$form['export']['export_options']['export_install_auto'] = [
...
$form['export']['export_options']['export_install_default'] = [
  // Currently not implemented/working.
  '#access' => FALSE,
  '#type' => 'checkbox',
  ...
  '#states' => [
    'enabled' => [
      ':input[name="export[export_options][export_install_auto]"]' => ['checked' => TRUE],
    ],
  ],
];

$form['export']['export_options']['export_include_block_positions'] = [
  // Currently not implemented/working.
  '#access' => FALSE,
  '#type' => 'checkbox',
...
// @todo: Ensure functionality matches this behavior to NOT inherit from Omega.
$form['export']['export_options']['export_inherit_layout'] = [
  '#type' => 'checkbox',
...
$form['export']['export_options']['export_include_templates'] = [
  '#type' => 'checkbox',
...
$form['export']['export_options']['export_enable_scss_support'] = [
  '#type' => 'checkbox',
...
$form['export']['export_options']['export_enable_configrb'] = [
  '#type' => 'checkbox',
...
$form['export']['export_options']['export_enable_gemfile'] = [
  '#type' => 'checkbox',
...
$form['export']['export_options']['export_enable_gruntfile'] = [
  '#type' => 'checkbox',
...
$form['export']['export_options']['export_enable_gulpfile'] = [
  '#type' => 'checkbox',
...
$form['export']['export_options']['export_include_blank_library'] = [
  '#type' => 'checkbox',
...
$form['export']['export_options']['export_include_theme_settings_php'] = [
  '#type' => 'checkbox',
